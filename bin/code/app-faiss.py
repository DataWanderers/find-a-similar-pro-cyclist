...
def update_similar_riders(rider, k=10, age_max=30, countries=""):
    pop_indices = update_index(
        index, arr_emb, df_meta, age_max=age_max, countries=countries
    )
    rider_i, D, I = find_closest_riders(
        index, arr_emb, rider=rider, riders_all=RIDERS, k=k
    )
